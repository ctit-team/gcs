...
Item {
    ...
    Item {
        ...
        MessageDialog {
            ...
            modality:           Qt.ApplicationModal
            visible:            false
            onYes:              mainWindow.finishCloseProcess()
        ...
        function showMessageArea() {
            ...
            if(!currentlyVisible) {
                ...
                mainWindow.currentPopUp = messageArea
        ...
        function showPopUp(dropItem, centerX) {
            ...
            if(oldIndicator !== dropItem) {
                ...
                mainWindow.currentPopUp = indicatorDropdown
            }
        }
    ...
    /*
        ...
        MouseArea {
            visible:        mainWindow.currentPopUp != null
            enabled:        mainWindow.currentPopUp != null
            anchors.fill:   parent
            onClicked: {
                mainWindow.currentPopUp.close()
            }
